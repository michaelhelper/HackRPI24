...
const AboutUs: React.FC = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      content:
        'Noise Scape leverages  technologies and real-time data collection to create comprehensive noise maps. Our use of spatial interpolation ensures continuous coverage, even in areas with sparse data points.',
    },
    {
